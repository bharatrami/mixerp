...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    <pes:Form ID="ItemSellingPriceForm" runat="server" Text="Item Selling Price Maintenance" TableSchema="core" Table="item_selling_prices" KeyColumn="item_selling_price_id"
        ...
        SelectedValues=""
        DisplayFields="core.items.item_id-->item_code + ' (' + item_name + ')', core.customer_types.customer_type_id-->customer_type_code + ' (' + customer_type_name + ')', core.price_types.price_type_id-->price_type_code + ' (' + price_type_name + ')' " />
</asp:Content>
